const projects = [
  {
    ...
    features: [
      "OCR pipeline via AWS Lambda + Python (Tesseract) for automated report extraction",
      "Kafka-based async processing for high-throughput report ingestion",
      "Elasticsearch for fast full-text medical report search",
      "Severity-based recommendation engine with rule-driven health insights",
    ],
    tags: ["Java", "Spring Boot", "Kafka", "Elasticsearch", "AWS Lambda", "MySQL", "Python", "Tesseract OCR"],
    confidential: "Production System · Code Confidential",
    accent: {
  ...
  },
  {
    ...
    features: [
      "Loan eligibility engine with configurable rule-based approval workflows",
      "RESTful APIs for end-to-end loan application and status tracking",
      "Business rule validation with structured custom exception handling",
      "Optimized DB queries and indexing for high-performance reporting",
    ],
    tags: ["Java", "Spring Boot", "Spring Security", "MySQL", "JPA / Hibernate", "REST APIs"],
